...
const MainProjects = () => {
    let allProgects = [
        {img: "img/projects/riversite.png",projectName: 'Riversate', tools: 'HTML SCSS JS React Redux', projectDescription: 'Delivery web site (is updating)', url: "https://riversite-bba63.web.app/"},
        ...
        {img: "img/projects/coffee-shop.png",projectName: 'Coffe shop', tools: 'HTML SCSS JS React', projectDescription: 'My first website on React', url: "https://github.com/Marflow159/coffee_shop"}
    ]
